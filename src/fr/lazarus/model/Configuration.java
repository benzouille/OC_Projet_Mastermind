...
/**
 * Classe recupérant les données présentes dans le config.properties et les enregistrants après modification
 */
public class Configuration {
    ...
    /**
     * Constructeur, initialise la classe avec les paramtres
     * @param tourPlusMoins int
     * @param tourMast int
     * @param combiPlusMoins int
     * @param combiMast int
     * @param couleurMast int
     * @param devMod boolean
     * @param devModEnJeu boolean
     */
    ...
    /**
     * Desciptif de L'objet
     * @return str
     */
    public String toString() {
        String str = "Configuration [tourPlusMoins=" + tourPlusMoins + ", tourMast=" + tourMast + ", combiPlusMoins="

...
public class PopUpFinPartie extends JDialog implements Observable{
    ...
    private String gagne = "Bravo vous avez gagné !",
            ...
            perduOrdinateur = "Dommage l'ordinateur vous a battu.",
            title,
            choixFinJeu;
    ...
    public void initComponent() {
        ...
        if (title == "Perdu" ) {
            ...
            else if( partie.getModeDePartie().equals(ModeDePartie.PLUS_DEF) || partie.getModeDePartie().equals(ModeDePartie.MAST_DEF)){
                jlText.setText(perduOrdinateur);
                jpText.add(jlText);
            }
        }
        else {
    ...
    class MenuPrincipalListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            logger.info("choix : menu principal");
            updateObservateur();
        }
    }
